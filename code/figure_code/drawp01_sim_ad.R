here::i_am("code/figure_code/drawp01_sim_ad.R")
...
p.fdp.50 <- draw_fdp_a(
  NP.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.50_it.48_fil.FALSE.NP.RDS"))),
  as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.50_it.48_fil.FALSE.NP.RDS")))),
  NB.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.50_it.48_fil.FALSE.NB.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.50_it.48_fil.FALSE.NB.RDS")))),
  q = 0.1, n = 50
)


p.fdp.100 <- draw_fdp_a(
  NP.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.100_it.48_fil.FALSE.NP.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.100_it.48_fil.FALSE.NP.RDS")))),
  NB.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.100_it.48_fil.FALSE.NB.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.100_it.48_fil.FALSE.NB.RDS")))),
  q = 0.1, n = 100
)

p.fdp.200 <- draw_fdp_a(
  NP.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.200_it.48_fil.FALSE.NP.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.200_it.48_fil.FALSE.NP.RDS")))),
  NB.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.200_it.48_fil.FALSE.NB.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.200_it.48_fil.FALSE.NB.RDS")))),
  q = 0.1, n = 200
)

p.fdp.400 <- draw_fdp_a(
  NP.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.400_it.48_fil.FALSE.NP.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.400_it.48_fil.FALSE.NP.RDS")))),
  NB.df = merge(as_tibble(readRDS(file = here("output/sim_df_out/nc.8_pn0.9_ns.400_it.48_fil.FALSE.NB.RDS"))),
                as_tibble(readRDS(file = here("output/sim_ad_out/nc.8_pn0.9_ns.400_it.48_fil.FALSE.NB.RDS")))),
  q = 0.1, n = 400
)
...
ggsave(file = here("output/sim_ad_figures/fprboxp01.pdf"), g, width = 13, height = 13)
...
ggsave(file = here("output/sim_ad_figures/powerboxp01.pdf"), g, width = 13, height = 13)
...
ggsave(file = here("output/sim_ad_figures/powerp01.pdf"), g, width = 13, height = 8)
...
ggsave(file = here("output/sim_ad_figures/fprp01.pdf"), g, width = 13, height = 8)
