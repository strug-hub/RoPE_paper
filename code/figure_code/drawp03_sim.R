here::i_am("code/figure_code/drawp03_sim.R")
...
ggsave(file = here("output/sim_figures/fprboxp03.pdf"), g, width = 15, height = 5)
...
ggsave(file = here("output/sim_figures/powerboxp03.pdf"), g, width = 15, height = 5)
...
ggsave(file = here("output/sim_figures/powerp03.pdf"), g, width = 13, height = 8)
...
ggsave(file = here("output/sim_figures/fprp03.pdf"), g, width = 13, height = 8)
