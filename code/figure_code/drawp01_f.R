here::i_am("code/figure_code/drawp01_f.R")
...
p.fdp.50 <- draw_fdp(
  NP.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.50_it.48_fil.TRUE.NP.RDS"))),
  NB.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.50_it.48_fil.TRUE.NB.RDS"))),
  q = 0.1, n = 50
)
p.fdp.100 <- draw_fdp(
  NP.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.100_it.48_fil.TRUE.NP.RDS"))),
  NB.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.100_it.48_fil.TRUE.NB.RDS"))),
  q = 0.1, n = 100
)
p.fdp.200 <- draw_fdp(
  NP.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.200_it.48_fil.TRUE.NP.RDS"))),
  NB.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.200_it.48_fil.TRUE.NB.RDS"))),
  q = 0.1, n = 200
)
p.fdp.400 <- draw_fdp(
  NP.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.400_it.48_fil.TRUE.NP.RDS"))),
  NB.df = as_tibble(readRDS(file = here("output/diff_exp_out_f/nc.8_pn0.9_ns.400_it.48_fil.TRUE.NB.RDS"))),
  q = 0.1, n = 400
)
...
ggsave(file = here("output/figures_f/fprboxp01_f.pdf"), g, width = 15, height = 5)
...
ggsave(file = here("output/figures_f/powerboxp01_f.pdf"), g, width = 15, height = 5)
...
ggsave(file = here("output/figures_f/powerp01_f.pdf"), g, width = 13, height = 8)
...
ggsave(file = here("output/figures_f/fprp01_f.pdf"), g, width = 13, height = 8)
